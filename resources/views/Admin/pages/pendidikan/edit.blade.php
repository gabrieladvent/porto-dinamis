...
@section('adminKonten')
    <div class="card-header clearfix">
        <a href="{{ route('pendidikan.index') }}" class="btn btn-secondary float-start">
            << Kembali</a>
