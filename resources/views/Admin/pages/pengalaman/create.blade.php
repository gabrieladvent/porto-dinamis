...
@section('adminKonten')
    <div class="card-header clearfix">
        <a href="{{ route('pengalaman.index') }}" class="btn btn-secondary float-start">
            << Kembali</a>
    ...
    <div class="card-body">
        <form action="{{ route('pengalaman.store') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="judul" id="" class="form-control" value="{{ old('judul') }}"
                    placeholder="Posisi...">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Perusahaan</label>
                <input type="text" name="info1" id="info1" class="form-control" value="{{ old('info1') }}"
                    placeholder="Nama Perusahaan...">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Alamat Perusahaan</label>
                <input type="text" name="info2" id="info2" class="form-control" value="{{ old('info2') }}"
